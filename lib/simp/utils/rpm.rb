  ...
  module Util
    ...
    class Simp::Utils::RPM
      ...
      def initialize(rpm_source)
        info = Simp::Utils::RPM.get_info(rpm_source)
        @basename = info[:name]
      ...
      # Copy specific content from one directory to another.
      #
      # @param [String] start_dir the root directory where the original files are located
      # @param [String] src a pattern given to find(1) to match against the desired files to copy
      # @param [String] dest the destination directory to receive the copies
      ...
      # {
      #   :mock_obj   => Mock object to execute
      ...
      # for it.
      # @param [String] gpg_key Full path to the **directory** where the key resides
