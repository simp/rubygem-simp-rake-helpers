...
Requires: simp-puppetmodule-helper
...
%pre
/usr/local/bin/simp_pupmod_update pre $1

# when $1 = 1, this is an install
# when $1 = 2, this is an upgrade
%post
/usr/local/bin/simp_pupmod_update post $1
...
%preun
/usr/local/bin/simp_pupmod_update preun $1

# when $1 = 1, this is the uninstall of the previous version during an upgrade
# when $1 = 0, this is the uninstall of the only version during an erase
%postun
/usr/local/bin/simp_pupmod_update postun $1
